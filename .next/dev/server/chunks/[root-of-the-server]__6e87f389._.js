...
async function getUserFromCookie() {
    ...
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verify(token.value, JWT_SECRET);
    } catch (e) {
        return null;
    }
}
async function GET() {
    ...
    try {
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query('SELECT * FROM tokens ORDER BY created_at DESC');
...
async function POST() {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query('INSERT INTO tokens (token, created_by, usage_count) VALUES ($1, $2, 0)', [
            token,
            user.user
        ]);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6e87f389._.js.map